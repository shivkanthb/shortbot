...
class TableController: UITableViewController {
    ...
    @IBAction func addBot(_ sender: Any) {
        ...
        let confirmAction = UIAlertAction(title: "Confirm", style: .default) { (_) in
            if let field = alertController.textFields?[0] {
                // store your data
                UserDefaults.standard.set(field.text, forKey: "boturl")
    ...
    func fillData()
    {
        TableData.append("Bot 1");
        TableData.append("Bot 2");
        TableData.append("Bot 3");
        TableData.append("Bot 4");
        DispatchQueue.main.async(execute: {self.refresh_table()})
    }
